...
% mutual information
load PC_train_11.txt % loads input data
data=PC_train_11(:,3:end);% input starting from row 3 upto end are considered sample data 

c1 =PC_train_11(:,1);% first row input is cosidered as class label
